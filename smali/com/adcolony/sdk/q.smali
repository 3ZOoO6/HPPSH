...
.method public static synthetic a(Lcom/adcolony/sdk/q;)Lcom/adcolony/sdk/f;
    .locals 0
...
.method public static synthetic b(Lcom/adcolony/sdk/q;)Lcom/adcolony/sdk/f;
    .locals 0
...
.method public a(J)Ljava/util/concurrent/Callable;
    .locals 1
...
.method public a(Landroid/content/Context;Lcom/adcolony/sdk/y;)V
    .locals 1
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
    .param p2    # Lcom/adcolony/sdk/y;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/Signature;
...
.method public b(J)Ljava/util/concurrent/Callable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J)",
...
.method public b(Landroid/content/Context;Lcom/adcolony/sdk/y;)V
    .locals 2
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
...
.method public c()Lcom/adcolony/sdk/f1;
    .locals 3
...
.method public c(J)Lcom/adcolony/sdk/f1;
    .locals 4
...
.method public d()Lcom/adcolony/sdk/f1;
    .locals 5
...
.method public t()Lcom/adcolony/sdk/f1;
    .locals 6
...
.method public x()Landroid/graphics/Rect;
    ...
    :cond_3
    invoke-static {v2}, Landroidx/core/location/c;->B(Landroid/view/WindowManager;)Landroid/view/WindowMetrics;
    ...
    invoke-static {v1}, Landroidx/compose/foundation/layout/a;->f(Landroid/content/Context;)Landroid/view/Display;

    move-result-object v1

    invoke-virtual {v1, v3, v4}, Landroid/view/Display;->getCurrentSizeRange(Landroid/graphics/Point;Landroid/graphics/Point;)V

    invoke-static {v2}, Landroidx/core/location/c;->g(Landroid/view/WindowMetrics;)Landroid/graphics/Rect;
    ...
    :catch_0
    :try_start_2
    invoke-static {v2}, Landroidx/core/location/c;->i(Landroid/view/WindowMetrics;)Landroid/view/WindowInsets;

    move-result-object v1

    invoke-static {}, Landroidx/core/view/r;->l()I

    move-result v3

    invoke-static {}, Landroidx/core/view/r;->w()I
    ...
    invoke-static {v1, v3}, Landroidx/core/view/r;->c(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
    ...
    invoke-static {v1}, Landroidx/activity/i;->u(Landroid/graphics/Insets;)I

    move-result v4

    invoke-static {v1}, Landroidx/activity/i;->a(Landroid/graphics/Insets;)I
    ...
    invoke-static {v1}, Landroidx/activity/i;->p(Landroid/graphics/Insets;)I

    move-result v4

    invoke-static {v1}, Landroidx/activity/i;->w(Landroid/graphics/Insets;)I
...
.method public z()Lcom/adcolony/sdk/f1;
    .locals 1
