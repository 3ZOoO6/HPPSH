...
.method public static constructor <clinit>()V
    ...
    new-instance v1, Lcom/androidnetworking/interceptors/HttpLoggingInterceptor$Level;

    const-string v3, "BASIC"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/androidnetworking/interceptors/HttpLoggingInterceptor$Level;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/androidnetworking/interceptors/HttpLoggingInterceptor$Level;->BASIC:Lcom/androidnetworking/interceptors/HttpLoggingInterceptor$Level;

    new-instance v3, Lcom/androidnetworking/interceptors/HttpLoggingInterceptor$Level;

    const-string v5, "HEADERS"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/androidnetworking/interceptors/HttpLoggingInterceptor$Level;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/androidnetworking/interceptors/HttpLoggingInterceptor$Level;->HEADERS:Lcom/androidnetworking/interceptors/HttpLoggingInterceptor$Level;

    new-instance v5, Lcom/androidnetworking/interceptors/HttpLoggingInterceptor$Level;

    const-string v7, "BODY"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/androidnetworking/interceptors/HttpLoggingInterceptor$Level;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/androidnetworking/interceptors/HttpLoggingInterceptor$Level;->BODY:Lcom/androidnetworking/interceptors/HttpLoggingInterceptor$Level;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/androidnetworking/interceptors/HttpLoggingInterceptor$Level;
    ...
    sput-object v7, Lcom/androidnetworking/interceptors/HttpLoggingInterceptor$Level;->$VALUES:[Lcom/androidnetworking/interceptors/HttpLoggingInterceptor$Level;
