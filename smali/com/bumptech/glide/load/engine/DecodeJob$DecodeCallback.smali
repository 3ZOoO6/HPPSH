...
.method public final a(Lcom/bumptech/glide/load/engine/Resource;)Lcom/bumptech/glide/load/engine/Resource;
    ...
    iget-object v3, v0, Lcom/bumptech/glide/load/engine/DecodeJob;->b:Lcom/bumptech/glide/load/engine/DecodeHelper;

    const/4 v4, 0x0

    if-eq v2, v1, :cond_0

    invoke-virtual {v3, v9}, Lcom/bumptech/glide/load/engine/DecodeHelper;->c(Ljava/lang/Class;)Lcom/bumptech/glide/load/Transformation;

    move-result-object v1

    iget-object v5, v0, Lcom/bumptech/glide/load/engine/DecodeJob;->j:Lcom/bumptech/glide/GlideContext;

    iget v6, v0, Lcom/bumptech/glide/load/engine/DecodeJob;->n:I

    iget v7, v0, Lcom/bumptech/glide/load/engine/DecodeJob;->o:I
    ...
    invoke-virtual {p1, v1}, Lcom/bumptech/glide/Registry;->isResourceEncoderAvailable(Lcom/bumptech/glide/load/engine/Resource;)Z
    ...
    invoke-virtual {p1, v1}, Lcom/bumptech/glide/Registry;->getResultEncoder(Lcom/bumptech/glide/load/engine/Resource;)Lcom/bumptech/glide/load/ResourceEncoder;

    move-result-object v4

    iget-object p1, v0, Lcom/bumptech/glide/load/engine/DecodeJob;->q:Lcom/bumptech/glide/load/Options;

    invoke-interface {v4, p1}, Lcom/bumptech/glide/load/ResourceEncoder;->getEncodeStrategy(Lcom/bumptech/glide/load/Options;)Lcom/bumptech/glide/load/EncodeStrategy;
    ...
    iget-object v4, v0, Lcom/bumptech/glide/load/engine/DecodeJob;->z:Lcom/bumptech/glide/load/Key;
    ...
    iget-object v5, v0, Lcom/bumptech/glide/load/engine/DecodeJob;->p:Lcom/bumptech/glide/load/engine/DiskCacheStrategy;

    invoke-virtual {v5, v4, v2, p1}, Lcom/bumptech/glide/load/engine/DiskCacheStrategy;->isResourceCacheable(ZLcom/bumptech/glide/load/DataSource;Lcom/bumptech/glide/load/EncodeStrategy;)Z
    ...
    invoke-virtual {v2}, Lcom/bumptech/glide/GlideContext;->getArrayPool()Lcom/bumptech/glide/load/engine/bitmap_recycle/ArrayPool;

    move-result-object v3

    iget-object v4, v0, Lcom/bumptech/glide/load/engine/DecodeJob;->z:Lcom/bumptech/glide/load/Key;

    iget-object v5, v0, Lcom/bumptech/glide/load/engine/DecodeJob;->k:Lcom/bumptech/glide/load/Key;

    iget v6, v0, Lcom/bumptech/glide/load/engine/DecodeJob;->n:I

    iget v7, v0, Lcom/bumptech/glide/load/engine/DecodeJob;->o:I

    iget-object v10, v0, Lcom/bumptech/glide/load/engine/DecodeJob;->q:Lcom/bumptech/glide/load/Options;
    ...
    iget-object v2, v0, Lcom/bumptech/glide/load/engine/DecodeJob;->z:Lcom/bumptech/glide/load/Key;

    iget-object v3, v0, Lcom/bumptech/glide/load/engine/DecodeJob;->k:Lcom/bumptech/glide/load/Key;
    ...
    :goto_4
    sget-object v2, Lcom/bumptech/glide/load/engine/LockedResource;->g:Landroidx/core/util/Pools$Pool;
    ...
    iput-boolean v12, v2, Lcom/bumptech/glide/load/engine/LockedResource;->f:Z

    iput-boolean v13, v2, Lcom/bumptech/glide/load/engine/LockedResource;->d:Z

    iput-object v1, v2, Lcom/bumptech/glide/load/engine/LockedResource;->c:Lcom/bumptech/glide/load/engine/Resource;

    iget-object v0, v0, Lcom/bumptech/glide/load/engine/DecodeJob;->h:Lcom/bumptech/glide/load/engine/DecodeJob$DeferredEncodeManager;
