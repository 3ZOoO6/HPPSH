...
.method private findContextForPackage(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;
    ...
    invoke-static {v1, p1}, Landroid/support/v4/media/a;->p(Ljava/lang/String;Landroid/net/Uri;)Ljava/lang/String;
...
.method private findResourceIdFromResourceIdUri(Landroid/net/Uri;)I
    ...
    invoke-static {v2, p1}, Landroid/support/v4/media/a;->p(Ljava/lang/String;Landroid/net/Uri;)Ljava/lang/String;
...
.method private findResourceIdFromTypeAndNameResourceUri(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-static {v0, p2}, Landroid/support/v4/media/a;->p(Ljava/lang/String;Landroid/net/Uri;)Ljava/lang/String;
...
.method public decode(Landroid/net/Uri;IILcom/bumptech/glide/load/Options;)Lcom/bumptech/glide/load/engine/Resource;
    ...
    invoke-direct {v0, p1}, Lcom/bumptech/glide/load/resource/drawable/NonOwnedDrawableResource;-><init>(Landroid/graphics/drawable/Drawable;)V
