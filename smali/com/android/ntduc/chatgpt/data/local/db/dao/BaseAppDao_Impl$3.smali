.class Lcom/android/ntduc/chatgpt/data/local/db/dao/BaseAppDao_Impl$3;
...
.method public final createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `BaseApp` SET `name` = ?,`packageName` = ?,`category` = ?,`dataDir` = ?,`minSdkVersion` = ?,`targetSdkVersion` = ?,`nativeLibraryDir` = ?,`processName` = ?,`publicSourceDir` = ?,`size` = ?,`firstInstallTime` = ?,`lastUpdateTime` = ?,`sourceDir` = ?,`storageUuid` = ?,`taskAffinity` = ?,`uid` = ? WHERE `packageName` = ?"
