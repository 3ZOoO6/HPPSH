...
.method private handleConstraintsChanged(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;)V
    ...
    invoke-static {v0, p2}, Landroidx/work/impl/background/systemalarm/ConstraintProxy;->updateAll(Landroid/content/Context;Ljava/util/List;)V

    iget-object v1, p1, Landroidx/work/impl/background/systemalarm/ConstraintsCommandHandler;->c:Landroidx/work/impl/constraints/WorkConstraintsTracker;
    ...
    invoke-virtual {v7}, Landroidx/work/impl/model/WorkSpec;->calculateNextRunTime()J
    ...
    invoke-virtual {v7}, Landroidx/work/impl/model/WorkSpec;->hasConstraints()Z

    move-result v9

    if-eqz v9, :cond_1

    invoke-virtual {v1, v8}, Landroidx/work/impl/constraints/WorkConstraintsTracker;->areAllConstraintsMet(Ljava/lang/String;)Z
    ...
    invoke-static {v0, v3}, Landroidx/work/impl/background/systemalarm/CommandHandler;->createDelayMetIntent(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
    ...
    const-string v3, "Creating a delay_met command for workSpec with id (%s)"
    ...
    sget-object v8, Landroidx/work/impl/background/systemalarm/ConstraintsCommandHandler;->d:Ljava/lang/String;

    invoke-virtual {v6, v8, v3, v7}, Landroidx/work/Logger;->debug(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

    new-instance v3, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher$AddRunnable;

    iget v6, p1, Landroidx/work/impl/background/systemalarm/ConstraintsCommandHandler;->b:I

    invoke-direct {v3, v5, v6, p3}, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher$AddRunnable;-><init>(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;)V

    invoke-virtual {p3, v3}, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->postOnMainThread(Ljava/lang/Runnable;)V
...
.method private handleScheduleWorkIntent(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;)V
    ...
    invoke-static {p2, p3, p1, v5, v6}, Landroidx/work/impl/background/systemalarm/Alarms;->b(Landroid/content/Context;Landroidx/work/impl/WorkManagerImpl;Ljava/lang/String;J)V
    ...
    invoke-static {v1, v2, p1, v5, v6}, Landroidx/work/impl/background/systemalarm/Alarms;->b(Landroid/content/Context;Landroidx/work/impl/WorkManagerImpl;Ljava/lang/String;J)V
    ...
    invoke-direct {v1, p1, p2, p3}, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher$AddRunnable;-><init>(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;)V
...
.method private handleStopWork(Landroid/content/Intent;Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;)V
    ...
    const-string v5, "Handing stopWork work for %s"
    ...
    invoke-static {v0, p1, v3}, Landroidx/work/impl/background/systemalarm/Alarms;->a(Landroid/content/Context;Ljava/lang/String;I)V
    ...
    sget-object v5, Landroidx/work/impl/background/systemalarm/Alarms;->a:Ljava/lang/String;

    invoke-virtual {v0, v5, v2, v3}, Landroidx/work/Logger;->debug(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
