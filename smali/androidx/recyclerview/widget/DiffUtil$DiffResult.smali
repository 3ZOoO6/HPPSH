...
.method private findMatchingAddition(I)V
    ...
    :cond_2
    iget v2, v3, Landroidx/recyclerview/widget/DiffUtil$Diagonal;->c:I
...
.method private findMoveMatches()V
    ...
    :cond_1
    iget v1, v2, Landroidx/recyclerview/widget/DiffUtil$Diagonal;->c:I
...
.method public dispatchUpdatesTo(Landroidx/recyclerview/widget/ListUpdateCallback;)V
    ...
    iget v7, v6, Landroidx/recyclerview/widget/DiffUtil$Diagonal;->a:I

    iget v8, v6, Landroidx/recyclerview/widget/DiffUtil$Diagonal;->c:I

    add-int/2addr v7, v8

    iget v9, v6, Landroidx/recyclerview/widget/DiffUtil$Diagonal;->b:I
    ...
    invoke-static {v1, v12, v10}, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->getPostponedUpdate(Ljava/util/Collection;IZ)Landroidx/recyclerview/widget/DiffUtil$PostponedUpdate;

    move-result-object v10

    if-eqz v10, :cond_2

    iget v10, v10, Landroidx/recyclerview/widget/DiffUtil$PostponedUpdate;->b:I

    sub-int v10, v0, v10

    sub-int/2addr v10, v5

    invoke-virtual {p1, v2, v10}, Landroidx/recyclerview/widget/BatchingListUpdateCallback;->onMoved(II)V
    ...
    invoke-virtual {v11, v2, v12}, Landroidx/recyclerview/widget/DiffUtil$Callback;->getChangePayload(II)Ljava/lang/Object;

    move-result-object v11

    invoke-virtual {p1, v10, v5, v11}, Landroidx/recyclerview/widget/BatchingListUpdateCallback;->onChanged(IILjava/lang/Object;)V
    ...
    invoke-direct {v10, v2, v11, v5}, Landroidx/recyclerview/widget/DiffUtil$PostponedUpdate;-><init>(IIZ)V
    ...
    invoke-direct {v7, v3, v11, v10}, Landroidx/recyclerview/widget/DiffUtil$PostponedUpdate;-><init>(IIZ)V
    ...
    invoke-virtual {v7, v11, v3}, Landroidx/recyclerview/widget/DiffUtil$Callback;->getChangePayload(II)Ljava/lang/Object;
    ...
    invoke-virtual {v8, v3, v7}, Landroidx/recyclerview/widget/DiffUtil$Callback;->getChangePayload(II)Ljava/lang/Object;

    move-result-object v8

    invoke-virtual {p1, v3, v5, v8}, Landroidx/recyclerview/widget/BatchingListUpdateCallback;->onChanged(IILjava/lang/Object;)V
